...
namespace cppgrad {
    ...
    //         out << "  " << tensor_id << " [label=\"Tensor\\nshape=";
    //         auto dims = current->data().dims();
    //         for (int i = 0; i < 4 && dims[i] > 1; ++i)
    //             out << dims[i] << ((i < 3 && dims[i+1] > 1) ? "x" : "");
    //         out << "\", shape=box];\n";
    //
    //         if (current->grad_fn()) {
    ...
    //
    //             out << "  " << fn_id << " [label=\"" << fn->name() << "\", shape=ellipse, style=filled, fillcolor=lightgray];\n";
    //             out << "  " << fn_id << " -> " << tensor_id << ";\n";
    //
    ...
    //                 out << "  " << input_id << " [label=\"Tensor\", shape=box];\n";
    //                 out << "  " << input_id << " -> " << fn_id << ";\n";
    //
    //                 queue.push(input);
    //             }
